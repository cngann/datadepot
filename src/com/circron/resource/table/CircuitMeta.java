...
@XmlRootElement
@Entity
@EntityType(value = 25L, recordEvents = true, recordStatus = true)
@Table(name = "circuit_meta")
public class CircuitMeta {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id", columnDefinition = "int(11) NOT NULL AUTO_INCREMENT")
    private Long id;
    @Column(name = "circuit_id", columnDefinition = "int(11) NOT NULL DEFAULT 1")
